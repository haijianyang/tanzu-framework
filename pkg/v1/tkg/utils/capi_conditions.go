...
type Getter interface {
	crtclient.Object
	GetConditions() capiv1.Conditions
}

// Get returns the condition with the given type, if the condition does not exist,
// it returns nil.
func Get(from Getter, t capiv1.ConditionType) *capiv1.Condition {
...
func Has(from Getter, t capiv1.ConditionType) bool {
...
func IsTrue(from Getter, t capiv1.ConditionType) bool {
...
func IsFalse(from Getter, t capiv1.ConditionType) bool {
	if c := Get(from, t); c != nil {
...
func IsUnknown(from Getter, t capiv1.ConditionType) bool {
	if c := Get(from, t); c != nil {
...
func GetReason(from Getter, t capiv1.ConditionType) string {
	if c := Get(from, t); c != nil {
		return c.Reason
	}
	return ""
...
func GetMessage(from Getter, t capiv1.ConditionType) string {
	if c := Get(from, t); c != nil {
		return c.Message
	}
	return ""
...
// does not exist (is nil).
func GetSeverity(from Getter, t capiv1.ConditionType) *capiv1.ConditionSeverity {
	if c := Get(from, t); c != nil {
		return &c.Severity
	}
	return nil
