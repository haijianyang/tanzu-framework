...
func (c *tkgctl) GetMachineDeployments(options client.GetMachineDeploymentOptions) ([]capiv1.MachineDeployment, error) {
...
func (c *tkgctl) GetPacificMachineDeployments(options client.GetMachineDeploymentOptions) ([]capiv1.MachineDeployment, error) {
